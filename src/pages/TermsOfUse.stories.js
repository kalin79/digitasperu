...
import LegalPage from '@Components/LegalPage/LegalPage.twig'
...
import * as LegalPageStories from '@Components/LegalPage/LegalPage.stories'
...
const Template = (args, context) => [
  AppHeaderStories.Light({
    ...
    pageTitle: LegalPageStories.Basic.args.title,
  }, context),
  LegalPage(LegalPageStories.Basic.args),
